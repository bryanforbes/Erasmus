...
def check(predicate: CheckType) -> DecoratorType[Any]: ...


def has_role(name: str) -> DecoratorType[Any]: ...


def has_any_role(*names: str) -> DecoratorType[Any]: ...


def has_permissions(**perms: bool) -> DecoratorType[Any]: ...


def bot_has_role(*names: str) -> DecoratorType[Any]: ...


def bot_has_permissions(**perms: bool) -> DecoratorType[Any]: ...


def guild_only() -> DecoratorType[Any]: ...


def is_owner() -> DecoratorType[Any]: ...


def is_nsfw() -> DecoratorType[Any]: ...


def cooldown(rate: int, per: float, type: BucketType = ...) -> DecoratorType[Any]: ...
