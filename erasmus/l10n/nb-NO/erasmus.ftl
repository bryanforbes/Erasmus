...
cooldown-error = Du kan prøve igjen om { INTERVAL($interval) }.
user-on-cooldown = Du har utført denne handlingen for mange ganger. Du kan prøve igjen om { INTERVAL($interval) }.
command-on-cooldown = Du har utført denne handlingen for mange ganger i denne kanalen. Du kan prøve igjen om { INTERVAL($interval) }.
...
confess__search = søk
    ...
    .terms = Søkebegreper: _{ $terms }_
    .no-results = Jeg fant 0 resultater fra _{ $terms }_
